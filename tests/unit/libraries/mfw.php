...
if (!defined('MFWPATH_RDK'))
{
	define('MFWPATH_RDK', MFWPATH_BASE . '/libraries/mrdk');
}

// Set the MOOTOMBO!Framework root path as a constant if necessary.
if (!defined('MFWPATH_MEDIA'))
{
	define('MFWPATH_MEDIA', MFWPATH_BASE . '/media/mfw');
}
...
require_once (MFWPATH_RDK . '/core/loader.php');

/**
 * @param  string $path the mfw path to the class to import
 *
 * @return void
 */
...
// Init the factory
require_once (NFWPATH_FRAMEWORK . '/factory.php');
