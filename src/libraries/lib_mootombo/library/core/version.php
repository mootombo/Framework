...
final class MFWCoreVersion
{
	...
	// Link text.
	const MFWLINK_TEXT = 'The <a href="http://devxive.com/mootombo/framework">MOOTOMBO!Framework</a> is Free Software released under the <a href="http://gnu.org/licenses/gpl-2.0.html">GNU General Public License version 2 or later</a>.';

	/**
	 * Compares two a "PHP standardized" version number against the current MOOTOMBO!Framework version.
	 *
	 * @param     string     $version    The version of the MOOTOMBO!Framework which is compatible.
	 *
	...
	{
		return (version_compare(self::getShortVersion(), $version, 'eq') == 1);
	}
